...
public class TreeViewNode : BindableObject, ILazyLoadTreeViewNode
{
    ...
    public TreeViewNode(string name,string Imagepath, object value = null, bool isExtended = false, IList<IHasChildrenTreeViewNode> children = null)
    {
        Name = name;
        ImagePath = Imagepath;
        Value = value;
    ...
    public virtual string ImagePath { get => Imagepath; set => SetProperty(ref Imagepath, value); }
